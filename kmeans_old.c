...
/* run by gcc kmeans.c && gcc  -o kmeans kmeans.c && kmeans 3 200 < input1.txt */
...
void simple_kmean (double ** c_dot_list, double ** c_cluster_list,double * cluster_index_list, int n,int k,int d) {
     int i,j;
    int current_input_size, count;
    int *dot_at;
    int *move_dot_to;
    int *cluster_size;
